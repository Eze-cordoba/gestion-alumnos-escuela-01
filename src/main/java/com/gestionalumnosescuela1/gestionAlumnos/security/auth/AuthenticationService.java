...
import com.gestionalumnosescuela1.gestionAlumnos.security.config.JwtService;
import com.gestionalumnosescuela1.gestionAlumnos.security.token.Token;
import com.gestionalumnosescuela1.gestionAlumnos.security.token.TokenRepository;
import com.gestionalumnosescuela1.gestionAlumnos.security.token.TokenType;
...
public class AuthenticationService {
  ...
  public   AuthenticationResponse editarAlumno(int alumnoId, UpdateRequest request) {
   
	  Usuario usuario = repository.findById(alumnoId).orElseThrow(() -> new RuntimeException("Alumno no encontrado"));
  ...
  //METODO CREADO POR MI PARA ACTUALIZAR ALUMNO
